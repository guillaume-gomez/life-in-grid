...
function GitHubStarLink() : React.ReactElement {
    return(
        <a aria-label="Github" target="_blank" rel="noreferrer" href="https://github.com/guillaume-gomez/life-in-grid" className="btn btn-circle">
